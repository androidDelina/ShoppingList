...
class ShopItemFragment(
    ...
    private fun parseParams() {
        ...
        if (mode == MODE_EDIT && itemId == ShopItem.UNDEFINED_ID) {
            throw RuntimeException("Param shop item id is absent")
        }
        Log.e("parseParamsFragment", mode)
    }
    ...
    companion object {
        ...
        fun getShopItemAddFragmentInstance(): ShopItemFragment {
            return ShopItemFragment(MODE_ADD)
        }

        fun getShopItemEditFragmentnstance(shopItemId: Int): ShopItemFragment {
